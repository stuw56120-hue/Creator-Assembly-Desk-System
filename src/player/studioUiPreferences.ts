 ...
 * Source: packages/studio/src/utils/studioUiPreferences.ts
 *
 * Persists lightweight UI preferences (playback rate, mute, etc.) to
 * localStorage. Safe in non-browser contexts (returns empty / no-ops).
 *
