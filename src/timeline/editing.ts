 ...
 * Source: packages/studio/src/player/components/timelineEditing.ts
 *
 * Provides the exact drag math for the C.A.D.S. timeline: resolveTimelineMove,
 * resolveTimelineResize, resolveTimelineAutoScroll, centisecond rounding, and
 * edge-track creation. Logic is unchanged; only the import path is adapted.
 *
