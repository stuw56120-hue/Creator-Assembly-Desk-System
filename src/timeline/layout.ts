 ...
 * Source: packages/studio/src/player/components/timelineLayout.ts
 *
 * Tick generation, tick-label formatting, playhead/canvas geometry, zoom-anchor
 * math, and asset-drop resolution for the C.A.D.S. timeline. Logic is unchanged;
 * only import paths are adapted.
 *
...
import type { ZoomMode } from "../player/playerStore";
